...
export const metadata: Metadata = {
  ...
  description:
    'Explore our ongoing construction projects. Webcon Engineers is currently working on multiple PEB and civil construction projects across India.',
};

export default function OngoingProjectsPage() {
  const ongoingProjects = projects.filter((p) => p.categorySlug === 'ongoing');
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: 'url(/images/banner/banner-1.jpg)' }}
      >
